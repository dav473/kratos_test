...
# Kratos
        ...
        cd ../config
		wget https://raw.githubusercontent.com/dav473/kratos_test/main/identity.schema.json
		wget https://raw.githubusercontent.com/dav473/kratos_test/main/kratos.yml
